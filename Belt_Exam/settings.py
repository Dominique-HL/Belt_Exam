...
SECRET_KEY = 'c3(oeyizi*zwu605alccc9mknh(4ukz1tiz9qsn0h^^w##ng75'
...
DATABASES = {
    'default': {
        ...
        'USER': 'dominiquehenriquez', # postgres para macOS o 'USER': 'postgres', para Windows
        'PASSWORD': 'b3nito', # contraseña a la que la cambió al instalar Postgres
